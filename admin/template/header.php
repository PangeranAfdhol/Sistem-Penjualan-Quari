...
<head>
  ...
  <title>Sistem Penjualan Pasir dan Batu</title>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.php" class="logo"><b><?php echo $gudang['nama_gudang']; ?></b> <small style="padding-left:5px;font-size:13px;"><?php echo $gudang['alamat_gudang']; ?></small></a>
      <!--logo end-->
